...
indir='/Users/afischer/MATLAB/BuddInlet/Data/Tides_monthly/';
...
set(gcf,'color','w');
print(gcf,'-dtiff','-r300',[filepath 'BuddInlet/Figs/BuddInlet_tides_biomass.tif']);
hold off
...
set(gcf,'color','w');
print(gcf,'-dtiff','-r300',[filepath 'BuddInlet/Figs/BuddInlet_tides_biomass_scatter.tif']);
hold off
