...
plot(T.dt(idx),T.DST_ngL(idx),'ko-','Markersize',3,'markerfacecolor','w','linewidth',1); hold on
    ...
    ylabel({'DST (ng)'},'fontsize',9); hold on;
yyaxis right
green=brewermap(2,'Greens');
plot(T.dt(idx),T.PTX2_ngL(idx),'o-','Color',green(2,:),'MarkerFaceColor',green(2,:),'Markersize',2,'linewidth',1); hold on
    set(gca,'ylim',[0 400],'ytick',0:200:400,'xlim',[xax(1) xax(2)],'xticklabel',{},...
        'fontsize', 8,'tickdir','out','ycolor',green(2,:));
    ylabel({'PTX2 (ng)'},'fontsize',9); hold on;    
