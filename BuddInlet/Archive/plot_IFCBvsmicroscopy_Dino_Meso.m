...
load([filepath 'BuddInlet/Data/BuddInlet_data_summary'],'T','fli','dmatrix','ymatrix');
class_indices_path=[ifcbpath 'IFCB-Tools/convert_index_class/class_indices.mat'];   
...
exportgraphics(gcf,[filepath 'BuddInlet/Figs/Mesodinium_IFCB_fl_median.png'],'Resolution',100)    
hold off
...
% set figure parameters
exportgraphics(gcf,[filepath 'BuddInlet/Figs/Dinophysis_IFCB_fl_microscopy_25-50-75_percentile.png'],'Resolution',300)    
hold off
