...
exportgraphics(gcf,[filepath 'BuddInlet/Figs/World_map.png'],'Resolution',300)    
hold off
...
% set figure parameters
exportgraphics(gcf,[filepath 'BuddInlet/Figs/Map_PugetSound.png'],'Resolution',300)    
hold off
...
%% set figure parameters
exportgraphics(gcf,[filepath 'BuddInlet/Figs/Map_BuddInlet.png'],'Resolution',300)    
hold off