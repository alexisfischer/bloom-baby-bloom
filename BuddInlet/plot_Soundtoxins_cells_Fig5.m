...
%B=table2array(BI);
%present=B(:,2).*sum(B(:,3:5),2);
%fx=sum(present)./sum(B(:,2))
%%
...
subplot(2,1,2)
plot(BI.Month,(BI.Present+BI.Common+BI.Bloom),':',BI.Month,(BI.Common+BI.Bloom),'-','Color',c(1,:),'markersize',3,'linewidth',2); hold on
plot(SB.Month,(SB.Present+SB.Common+SB.Bloom),':',SB.Month,(SB.Common+SB.Bloom),'-','Color',c(2,:),'markersize',3,'linewidth',2); hold on
plot(QH.Month,(QH.Present+QH.Common+QH.Bloom),':',QH.Month,(QH.Common+QH.Bloom),'-','Color',c(3,:),'markersize',3,'linewidth',2); hold on
plot(DB.Month,(DB.Present+DB.Common+DB.Bloom),':',DB.Month,(DB.Common+DB.Bloom),'-','Color',c(4,:),'markersize',3,'linewidth',2); hold on
plot(MB.Month,(MB.Present+MB.Common+MB.Bloom),':',MB.Month,(MB.Common+MB.Bloom),'-','Color',c(5,:),'markersize',3,'linewidth',2); hold on
plot(LB.Month,(LB.Present+LB.Common+LB.Bloom),':',LB.Month,(LB.Common+LB.Bloom),'-','Color',c(6,:),'markersize',3,'linewidth',2); hold on
