...
set(gcf,'color','w');
print(gcf,'-dtiff','-r300',[filepath 'Figs/' var '_space_time_' num2str(yrrange(1)) '-' num2str(yrrange(end)) '.tif'])
hold off
...
print(gcf,'-dtiff','-r300',[filepath 'Figs/Avg_' num2str(str) '_map_SFB.tif'])
hold off
