...
filename3="~/Documents/UCSC_research/SCW_Dino_Project/Data/RAI/SCW_RAI_2007-2020.xls";
...
CHL=log10(SC.CHL); CHL(CHL<0)=0; DN=SC.dn; id=isnan(CHL); CHL(id)=[]; DN(id)=[]; %select non-nan chl data
...
figure; plot(DN, DINOrai); datetick('x','yy');
