...
[~,ia,ib]=intersect(dne,dni); x=log10(chl(ia)); y=log10(carbon(ib));
...
legend(L,['slope=' num2str(m) '; Int=' num2str(b) '; R^2=' num2str(Rsq) ''],...
 ...
 set(gca,'fontsize',12,'tickdir','out','ylim',[-.2 2.3],'ytick',0:1:2,...
     'xlim',[-.2 2.3],'xtick',0:1:3,...
    'yticklabel',{'1','10','100','1000'},...
    'xticklabel',{'1','10','100','1000'}); box on
xlabel('Chl-\ita\rm (\mug L^{-1})','fontsize',14);
ylabel('C (\mug L^{-1})','fontsize',14);

% set figure parameters
set(gcf,'color','w');
print(gcf,'-dtiff','-r500',[filepath 'Figs/IFCB_vs_ChlExtracted_log.tif']);
hold off