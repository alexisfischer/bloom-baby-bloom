...
% 2019
filename = '/Users/alexis.fischer/Documents/MATLAB/bloom-baby-bloom/Shimada/Data/46041h2019.txt';
startRow = 3;
...
% 2021
filename = '/Users/alexis.fischer/Documents/MATLAB/bloom-baby-bloom/Shimada/Data/46041h2021.txt';
startRow = 3;
formatSpec = '%4f%3f%3f%3f%3f%4f%5f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'TextType', 'string', 'EmptyValue', NaN, 'HeaderLines' ,startRow-1, 'ReturnOnError', false, 'EndOfLine', '\r\n');
...
save([filepath 'Shimada/Data/wind_46041'],'w19','w21');
