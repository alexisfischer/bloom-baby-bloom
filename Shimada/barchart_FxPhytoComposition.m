...
yr=2019; % 2019; 2021
filepath='~/Documents/MATLAB/bloom-baby-bloom/Shimada/'; %enter filepath
...
idx=contains(names,'Pseudonitzschia');
col(idx,:)=[0 0 0];
...
if fprint
    exportgraphics(fig,[filepath 'Figs/FxCommunity_Shimada' num2str(yr) '.png'],'Resolution',300)    
end
hold off 
