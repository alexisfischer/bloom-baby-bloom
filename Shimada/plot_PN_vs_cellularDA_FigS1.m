...
idx=(P.DT.Year==2019); cells19=P.Pseudonitzschia(idx); tox19=P.tox_PNcell(idx)./1000; km19=P.gap_km(idx);
idx=(P.DT.Year==2021); cells21=P.Pseudonitzschia(idx); tox21=P.tox_PNcell(idx)./1000; km21=P.gap_km(idx);
