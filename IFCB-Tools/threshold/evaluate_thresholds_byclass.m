...
slope = Coeffs(bin,2);
save([filepath 'IFCB-Data/Shimada/threshold/Coeff_' num2str(class2do_string) ''],'class2do_string','slope','bin','chosen_threshold');

exportgraphics(gcf,[filepath 'IFCB-Data/Shimada/threshold/Figs/Threshold_range_'  num2str(class2do_string) '.png'],'Resolution',100)    
hold off
