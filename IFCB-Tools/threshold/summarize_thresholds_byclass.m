...
%thsummary=[summarydir 'summary_allTB_bythre_' class2do_string];
...
slope = Coeffs(bin,2);
save([summarydir 'Coeff_' num2str(class2do_string) ''],'class2do_string','slope','bin','chosen_threshold');
...
exportgraphics(gca,[summarydir 'Figs/Threshold_range_'  num2str(class2do_string) '.png'],'Resolution',100)    
hold off
