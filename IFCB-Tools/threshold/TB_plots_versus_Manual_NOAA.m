...
exportgraphics(gca,[filepath 'Figs/Manual_automated_' num2str(class2do_string) '.png'],'Resolution',100)    
hold off
...
% set figure parameters
exportgraphics(gca,[filepath 'Figs/Manual_automated_line_' num2str(class2do_string) '.png'],'Resolution',100)    
hold off
