function [classcount, classbiovol, classC, classcount_above_optthresh, ...
    classbiovol_above_optthresh, classC_above_optthresh, classcount_above_adhocthresh,...
    classbiovol_above_adhocthresh, classC_above_adhocthresh, class2useTB]...
    = summarize_biovol_TBclassNOAA(classfile, feafile, adhocthresh)
