...
% target='diatom'; %'all' 'dinoflagellate' 'unclassified' 'otherphyto' 'nonliving' 'nanoplankton' 'zooplankton' 'larvae'

load([filepath 'bloom-baby-bloom/IFCB-Tools/get_indices/class_indices.mat'],'class','class_proper','category');
