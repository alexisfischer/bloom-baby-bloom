...
group='NOAA'; %[]; %'NOAAOSU'; %'OSU'; 

compile_train_features_SS(manualpath,feapath_base,outpath,maxn,minn,classifiername,class2useName,class2skip,class2group,group,ssnum);
