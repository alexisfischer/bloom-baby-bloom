...
outputpath = 'D:\general\ROI_images\'; %USER where to write out pngs
...
for filecount = 1:length(resultfilelist),
    ...
    category = {'Pseudo-nitzschia_small_1cell', 'Pseudo-nitzschia_large_1cell',...
        ...
        'Pseudo-nitzschia_small_6cell', 'Pseudo-nitzschia_large_6cell'}; %use this syntax to export ONLY the listed categories
