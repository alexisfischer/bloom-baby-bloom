...
[class2do_string,mdate,~,~,iraifx,fish,mcrpy,RAI]=matchClassifierwMicroscopy(filepath,class2do_string,chain,error,'2018');

load([filepath 'Data/IFCB_summary/class/summary_allTB_' yr],'class2useTB','ml_analyzedTB','mdateTB','classcountTB_above_optthresh');
...
%%
set(gcf,'color','w');
print(gcf,'-dtiff','-r400',[filepath 'Figs/' num2str(class2do_string) '_cells_SCW2018.tif']);
hold off