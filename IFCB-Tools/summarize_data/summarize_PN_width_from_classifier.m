...
for i = 1:length(classfiles)
    ...
    [PNcount_above_optthresh(i),PNcount(i),opt_cell1,opt_cell2,...
        opt_cell3,opt_cell4,wta_cell1,wta_cell2,wta_cell3,wta_cell4]...
        =TBclass_summarize_PN_width(classfiles{i},feafiles{i});
...
save([summarydir 'summary_PN_allTB_' yrrangestr],'runtypeTB','filecommentTB',...
    'class2useTB','ml_analyzedTB','mdateTB','filelistTB','PN*');

disp('Summary file stored here:')
disp([summarydir 'summary_PN_allTB_' yrrangestr])
end
