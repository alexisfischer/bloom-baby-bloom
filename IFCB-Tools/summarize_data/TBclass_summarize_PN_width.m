...
PNcount_above_optthresh=size(opt_cell1,1)+2*size(opt_cell2,1)+3*size(opt_cell3,1)+4*size(opt_cell4,1);
...
PNcount=size(wta_cell1,1)+2*size(wta_cell2,1)+3*size(wta_cell3,1)+4*size(wta_cell4,1);
