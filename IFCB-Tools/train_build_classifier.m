...
TopClasses{end+1}='Akashiwo'; TopClasses{end+1}='Lauderia';
TopClasses{end+1}='Pn_parasite'; TopClasses{end+1}='Pn_small';
TopClasses{end+1}='Pseudo-nitzschia'; TopClasses{end+1}='Detritus';
...
train_filename = 'Train_07Dec2021'; %USER what file contains your training features
result_str = 'Trees_';
