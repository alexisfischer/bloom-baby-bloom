...
id=find(strcmp(class,'Dinoflagellate_mix')); class{id}='Akashiwo'; %replace Dinomix with Akashiwo
...
compile_train_features_PNW(manualpath,feapath_base,outpath,maxn,minn,class2skip,[]);
...
train_filename = 'Train_22Sep2021'; %USER what file contains your training features
result_str = 'Trees_';
