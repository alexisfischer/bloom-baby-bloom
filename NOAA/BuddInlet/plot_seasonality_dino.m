...
scatter(T.dt(id1)+2*365,T.dinomax(id1),20); hold on
scatter(T.dt(id2)+365,T.dinomax(id2),20); hold on
scatter(T.dt(id3),T.dinomax(id3),20); hold on
set(gca,'xlim',[datetime('15-Apr-2023') datetime('15-Dec-2023')],...
    'xaxislocation','top','fontsize', 10,'tickdir','out','ycolor','k');  
    datetick('x','m'); box on; 
ylabel('Dinophysis/mL','fontsize',11)
legend('2021','2022','2023','fontsize', 10,'location','NE'); legend boxoff

subplot(2,1,2); %mesodinium
scatter(T.dt(id1)+2*365,T.mesomax(id1),20); hold on
scatter(T.dt(id2)+365,T.mesomax(id2),20); hold on
scatter(T.dt(id3),T.mesomax(id3),20); hold on
set(gca,'xlim',[datetime('15-Apr-2023') datetime('15-Dec-2023')],...
