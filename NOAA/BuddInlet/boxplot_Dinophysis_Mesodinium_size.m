...
load([filepath 'IFCB-Data/BuddInlet/manual/summary_meso_width_manual'],'ESD');
...
exportgraphics(gcf,[filepath 'NOAA/BuddInlet/Figs/Dinophysis_Mesodinium_BoxWhiskers.png'],'Resolution',300)    
hold off
