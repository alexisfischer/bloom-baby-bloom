...
yyaxis left
plot(T.dt(idx),val,'ks','linewidth',.5,'markerfacecolor','k'); hold on;
plot(T.dt,T.dino_fl,'k:',T.dt,T.dino_sc,'k-','linewidth',1.5); hold on;
    set(gca,'xlim',[xax(1) xax(2)],'ylim',[0 7],...
        'fontsize', 10,'tickdir','out','ycolor','k');   
    ylabel('Dinophysis','fontsize',11,'color','k'); hold on;    
yyaxis right
plot(T.dt,T.DST,'r*','Markersize',4,'linewidth',1.5); hold on;
    set(gca,'xlim',[xax(1) xax(2)],'ylim',[0 17],...
        'fontsize', 10,'tickdir','out','ycolor','r');  
    ylabel('DST','fontsize',11,'color','r'); hold on;
