...
exportgraphics(gcf,[filepath 'NOAA\BuddInlet\Figs\BI_particle_size_distribution_PMTA.png'],'Resolution',100)    
...
load([filepath 'IFCB-Data\BuddInlet\manual\summary_meso_width_manual'],'filecomment','runtype','mdate','ESD');
