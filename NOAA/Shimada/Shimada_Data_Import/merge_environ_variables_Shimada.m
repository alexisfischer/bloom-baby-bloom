...
%% pco2
load([filepath 'Data/pCO2_Shimada' yr],'dt','fco2');
...
clearvars dt fco2 dt1 dt2 num t ia ib pco2i dti

%%
%figure; plot(LON(ib),LAT(ib),'o'); % test plot

save([filepath 'Data/environ_Shimada' yr],'DT','LON','LAT','TEMP','SAL','FL','PCO2');