function [P19,P21] = find_PN_patch_coordinates(dt,lat,lon)
...
P21(3).idx=(lattemp>40.2 & lattemp<43.2);
P21(4).idx=(lattemp<39); 
P21(1).label={'Juan de Fuca'}; 
P21(2).label={'Heceta Bank'}; 
P21(3).label={'Trinidad Head'};
P21(4).label={'Southern CA'}; 
P21(1).col=col(1,:);
P21(2).col=col(3,:); 
P21(3).col=col(4,:); 
P21(4).col=col(5,:);    
