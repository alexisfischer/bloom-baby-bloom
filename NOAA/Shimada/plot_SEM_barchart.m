...
exportgraphics(gcf,[filepath 'NOAA/Shimada/Figs/SEM_bar_Shimada' num2str(yr) '.png'],'Resolution',300)    
hold off
...
% set figure parameters
exportgraphics(gcf,[filepath 'NOAA/Shimada/Figs/SEM_legend.png'],'Resolution',300)    
hold off
