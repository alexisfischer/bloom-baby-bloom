%% calculate MHW using the Hobday method
clear;
...
fprint=1;
yr=2021; % 2019; 2021
res = 0.25; % grid resolution (degrees)

if yr==2019
    load([filepath 'NOAA/Shimada/data/MHW_2019.mat'],'lat','lon','sst','clm','mhw','m90');
elseif yr==2021
    load([filepath 'NOAA/Shimada/data/MHW_2021.mat'],'lat','lon','sst','clm','mhw','m90');
end
...
if fprint==1
    exportgraphics(gca,[filepath 'NOAA/Shimada/Figs/MHW_Hobday_Shimada' num2str(yr) '.png'],'Resolution',300)    
end
hold off 