%% plot Columbia River climatology with 2019 and 2021 data
clear;
filepath = '~/Documents/MATLAB/bloom-baby-bloom/';
addpath(genpath('~/Documents/MATLAB/ifcb-analysis/')); % add new data to search path
addpath(genpath(filepath)); % add new data to search path

load([filepath 'NOAA/Shimada/Data/ColumbiaRiverDischarge'],'CR');

%%%% Turbidity climatology (2015-2022)
    [mdate_mat,y_mat,~,~] = timeseries2ydmat(datenum(CR.dt),CR.turbidity_mean);
...
exportgraphics(fig,[filepath 'NOAA/Shimada/Figs/ColumbiaRiverDischarge_1plot.png'],'Resolution',300)    


%% Discharge & Turbidity: 2 panel plot
...
exportgraphics(fig,[filepath 'NOAA/Shimada/Figs/ColumbiaRiverDischarge_Turbidity.png'],'Resolution',300)    

%% Discharge: 2 panel plots
...
exportgraphics(fig,[filepath 'NOAA/Shimada/Figs/ColumbiaRiverDischarge_2019-2021.png'],'Resolution',300)    

%% not enough data
% %%%% Suspended solids climatology (2015-2022)
%     [mdate_mat,y_mat,~,~] = timeseries2ydmat(datenum(CR.dt),CR.ssl);
%     m = mean(y_mat,2,'omitmissing'); m(60)=[];
%     sd = std(y_mat,0,2,'omitmissing'); sd(60)=[]; 
% 
%     % Smooth using a span of 10% of the total number of data points
