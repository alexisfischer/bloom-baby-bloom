...
load([filepath 'NOAA/Shimada/data/OISST_MHW_2019_2021_raw.mat'],'M','MHW19');

%%%% load in survey data 
load([filepath 'NOAA/Shimada/Data/environ_Shimada2019'],'DT','LAT','LON');
...
lat=Y;
lon=M.lon;
save([filepath 'NOAA/Shimada/data/MHW_2019.mat'],'lat','lon','sst','clm','mhw','m90');
