...
%%
save([result_path 'seascape_count_class_manual'],'matdate','seascape','ml_analyzed','classcount','filelist','class2use','N','O','U')

%% find top classes for each seascape
