function [phytoTotal,dino,diat,nano,zoop,carbonml,class2useTB,mdate] = extract_daily_carbon_SCW2018(biovol_path)
%% Process and extract daily phytoplankton-specific carbon for 2018 at SCW
