...
minn = 300; %minimum number for inclusion
class2skip = {'Alexandrium_doublet','Alexandrium_quad','Alexandrium_triplet',...
    'Ash_dark','Ash_glassy','Azadinium','Beads','Boreadinium','Centric<10',...
    'Ciliates','Clusterflagellate','Corethron','Desmid','Detritus','DinoMix',...
    'Dolichospermum','Entomoneis','FlagMix','Fragilariopsis','Gyrosigma',...
    'Helicotheca','Leptocylindrus','Lio_Thal','Navicula','Noctiluca','Paralia',...
    'Plagiolemma','Pollen','Torodinium','bubbles','cyst','small_misc',...
    'small_misc','unclassified','zooplankton_misc'};
...
train_filename = 'UserExample_Train_21Apr2019'; %USER what file contains your training features
...
classifier_oob_analysis('F:\IFCB104\manual\summary\UserExample_Trees_21Apr2019',...
