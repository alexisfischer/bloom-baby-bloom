function [s] = compile_physicalparameters_v2(filepath,phys)
% load in Delta Flow data
% organize SFB data into structures for each cruise

load([filepath 'Data/NetDeltaFlow'],'DN','X2');
load([filepath 'Data/distance_st18'],'d18','d19','st');
...
save([filepath 'Data/physical_param'],'s','S','Si');
