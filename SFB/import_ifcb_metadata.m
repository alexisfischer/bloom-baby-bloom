...
metadata.st = cell2mat(rawNumericColumns(:, 1));
metadata.filename = rawStringColumns(:, 1);
...
save('C:\Users\kudelalab\Documents\GitHub\bloom-baby-bloom\Data\list_st_filename.mat', 'metadata');
