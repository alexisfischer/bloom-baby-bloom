...
ylabel('Wind (m s^{-1})','fontsize',12, 'fontname', 'Arial');    
title('2016','fontweight','bold','fontsize',12, 'fontname', 'Arial');    
hold on

subplot(4,1,2); %temp
plot(a.dn,a.temp,'o-','Markersize',3,'color',[0,0.4470,0.7410]);
set(gca,'xgrid', 'on','ylim',[13 18],'ytick',14:2:18,...
    'xlim',[datenum('2016-08-01') datenum('2016-11-06')],...
    'xtick',[datenum('2016-08-01'),datenum('2016-09-01'),...
    datenum('2016-10-01'),datenum('2016-11-01')],...    
    'xticklabel',{},'tickdir','out');    
...
subplot(4,1,3); %Chl
plot(a.dn,a.chl,'*-','Markersize',3,'color',[0.8500,0.3250,0.0980]);
set(gca,'xgrid', 'on','ylim',[0 150],'ytick',0:50:150,...
    'xlim',[datenum('2016-08-01') datenum('2016-11-06')],...
    'xtick',[datenum('2016-08-01'),datenum('2016-09-01'),...
    datenum('2016-10-01'),datenum('2016-11-01')],...    
    'xticklabel',{},'tickdir','out');      
