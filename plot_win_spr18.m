...
set(gca,'xgrid', 'on','ylim',[10 17],'ytick',10:2:16,'xlim',[ax1 ax2],...
...
set(gca,'xgrid', 'on','ylim',[0 15],'ytick',0:5:15,'xlim',[ax1 ax2],...
    'xtick',[datenum('2018-02-01'),datenum('2018-03-01'),datenum('2018-04-01'),...
    datenum('2018-05-01')],'xticklabel',{},'tickdir','out');      
...
set(gca,'xgrid', 'on','ylim',[0 50],'ytick',0:10:50,'xlim',[ax1 ax2],...
...
subplot(4,1,2); %temp
plot(a.dn,a.temp,'o-','Markersize',3,'color',[0,0.4470,0.7410]);
set(gca,'xgrid', 'on','ylim',[13 18],'ytick',14:2:18,'xlim',[ax1 ax2],...
...
subplot(4,1,3); %Chl
plot(a.dn,a.chl,'*-','Markersize',3,'color',[0.8500,0.3250,0.0980]);
set(gca,'xgrid', 'on','ylim',[0 150],'ytick',0:50:150,'xlim',[ax1 ax2],...
    'xtick',[datenum('2016-08-01'),datenum('2016-09-01'),...
    datenum('2016-10-01'),datenum('2016-11-01')],...    
    'xticklabel',{},'tickdir','out');      
ylabel('Chl (mg m^{-3})','fontsize',12, 'fontname', 'Arial');    
...
set(gca,'xgrid', 'on','ylim',[0 410],'ytick',0:100:400,'xlim',[ax1 ax2],...
    'xtick',[datenum('2016-08-01'),datenum('2016-09-01'),...
    datenum('2016-10-01'),datenum('2016-11-01')],...
