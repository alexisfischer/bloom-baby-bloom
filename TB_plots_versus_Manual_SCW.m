...
datetick('x','m')
set(gca,'xgrid', 'on','ylim',[0 2],'ytick',0:1:2,...
    'xlim',[datenum('2016-08-01') datenum('2018-05-01')],'tickdir','out');    
ylabel(['\it' num2str(class2do_string) '\rm cells mL^{-1}\bf'],...
        'fontsize',12, 'fontname', 'Arial');    
hold on
...
datetick('x','m')
set(gca,'xgrid', 'on','ylim',[0 12],'ytick',0:4:12,...
    'xlim',[datenum('2016-08-01') datenum('2018-05-01')],'tickdir','out');    
ylabel(['\it' num2str(class2do_string) '\rm cells mL^{-1}\bf'],...
        'fontsize',12, 'fontname', 'Arial');    
hold on
...
datetick('x','m')
set(gca,'xgrid', 'on','ylim',[0 200],'ytick',0:50:200,...
    'xlim',[datenum('2016-08-01') datenum('2018-05-01')],'tickdir','out');    
ylabel(['\it' num2str(class2do_string) '\rm cells mL^{-1}\bf'],...
        'fontsize',12, 'fontname', 'Arial');    
hold on
...
hold all
datetick('x','m')
set(gca,'xgrid', 'on','ylim',[0 30],'ytick',0:10:30,...
    'xlim',[datenum('2016-08-01') datenum('2018-05-01')],'tickdir','out');    
ylabel(['\it' num2str(class2do_string) '\rm cells mL^{-1}\bf'],...
        'fontsize',12, 'fontname', 'Arial');    
hold on
